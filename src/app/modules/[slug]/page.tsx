    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="flex gap-3">
        <a
          ...
          className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 dark:text-white"
        >
          View on GitHub
        </a>
        {miniApp.demoUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700  dark:bg-blue-950 dark:text-blue-500 dark:hover:bg-blue-900"
          >
            Live Demo
          </a>
        )}
