...
export function useOptimisticVote({
  ...
  // Fixed: The ref is now synchronized with component mount/unmount using a useEffect.
  // This ensures rollback logic only fires when the component is genuinely still mounted.
