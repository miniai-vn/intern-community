...
/**
 * Inline spinner shown while an API call is in-flight.
 * Uses only a CSS animation — no extra dependencies.
 * aria-hidden because the parent button already carries aria-label.
 */
